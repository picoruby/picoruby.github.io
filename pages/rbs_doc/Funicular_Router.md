...
```ruby
instance.delete(String path, to: singleton(Component), ?as: String?, ?constraints: route_constraints_t?) -> void
```
### get
...
```ruby
instance.patch(String path, to: singleton(Component), ?as: String?, ?constraints: route_constraints_t?) -> void
```
### post

```ruby
instance.post(String path, to: singleton(Component), ?as: String?, ?constraints: route_constraints_t?) -> void
```
### put

```ruby
instance.put(String path, to: singleton(Component), ?as: String?, ?constraints: route_constraints_t?) -> void
```
### set_default
